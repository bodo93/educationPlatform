                ...
                <div class="container">
                    ...
                    <form action="/educationPlatform/search" method="post" style="padding-bottom: 30px;max-width: 800px;min-width: 220px;margin-right: 100;padding-right: 0px;">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col" style="margin-right: 40px;min-width: 130px;"><a class="btn btn-primary" role="button" href="/educationplatform/search" style="width: 142px;margin-top: 10px;"><?php echo $lang['cancel']?></a></div>
