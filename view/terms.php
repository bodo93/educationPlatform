...
<html>
    ...
    <body style="color: rgb(34,36,37);background-color: rgb(34,36,37);">
        ...
        <main class="page login-page">
            <section class="clean-block clean-form dark" style="padding-bottom: 10px;min-width: 660px;">
                <div class="container">
                    <div class="block-heading">
                        <h2 class="text-info">Geschäftsbedingungen</h2>
                    </div>
                </div>
            </section>
        </main>
        <div id="empresa" style="padding: 20px;margin: 0px;margin-top: 0px;padding-top: 40px;background-color: rgb(246,246,246);">
            <div class="container">
                <div class="row" style="margin-left: -10px;margin-right: -10px;">
                    <div class="col-sm-6 col-md-7 col-lg-7">
                        ...
                        <p style="min-height: 370px;">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren,
                            ...
                            accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.<br><br><br><br><br><br><a class="btn btn-primary btn-block" role="button" href="search" style="margin-top: 6px;min-width: 160px;max-width: 200px;">Schliessen</a></p>
                    </div>
